module.exports = {
    ...
    extends: ['expensify', 'plugin:@typescript-eslint/recommended', 'plugin:import/typescript'],
    plugins: ['react', 'react-native', 'import', '@typescript-eslint', 'eslint-plugin-tsdoc'],
    settings: {
        'import/resolver': {
